...
public class JdbcMealRepositoryImpl implements MealRepository {
    ...
    public JdbcMealRepositoryImpl(DataSource dataSource, JdbcTemplate jdbcTmpl, NamedParameterJdbcTemplate namedJdbcTmpl) {
        ...
        this.namedParameterJdbcTemplate = namedJdbcTmpl;
    }
    ...
    public Meal save(Meal meal, int userId) {
        ...
        } else if (namedParameterJdbcTemplate.update("UPDATE meals SET dateTime=:dateTime, description=:description, calories=:calories WHERE id=:id AND user_id=:userId", map) != 1) {
            return null;
        }
        return meal;
    }

            ...
            <div class="view-box">
                <form method="post" class="form-horizontal" role="form" id="filter">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input class="form-control time-picker" type="time" name="startTime" id="startTime">
                        </div>

                        <label class="control-label col-sm-2" for="endTime"><fmt:message key="meals.endTime"/>:</label>

                        <div class="col-sm-2">
                            <input class="form-control time-picker" type="time" name="endTime" id="endTime">
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <a class="btn btn-sm btn-info" onclick="add('<fmt:message key="meals.add"/>')"><img src="resources/images/icon-meal-2.png" width="23" />  <fmt:message key="meals.add"/></a>
